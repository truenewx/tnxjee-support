 ...
 * @param <U> 用户标识类型
 */
public interface FssServiceTemplate<T extends Enum<T>, U> extends Service {
     ...
     */
    FssUploadLimit getUploadLimit(T authorizeType, U user);
     ...
     * @return 指定资源的读取元信息
     */
    FssReadMetadata getReadMetadata(U user, String storageUrl);
